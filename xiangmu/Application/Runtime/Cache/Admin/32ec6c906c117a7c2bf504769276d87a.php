                                    ...
                                    <div class="widget-main">
                                        ...
                                        <form action="/Admin/Login/index" method="post">
                                            <fieldset>
                                                ...
                                                <label>
															<span class="block input-icon input-icon-right">
																<input type="text" class="span12" name="verify" placeholder="验证码" />
																<i class="icon-lock"></i>
															</span>
                                                </label>
                                                ...
                                                <label>
															<span class="block input-icon input-icon-right">
																<img class="img_change" src="/Admin/Login/captcha" onclick="this.src='/Admin/Login/captcha/_/'+Math.random()" width="150" height="100">
															</span>
                                                </label>
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <button type="submit" id="login-btn" class="width-35 pull-right btn btn-small btn-primary">
                                                        <i class="icon-key"></i>
                                                        登陆
                                                    </button>
                                                </div>
