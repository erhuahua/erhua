	...
	<!--<div id="header">-->
    	<!--<div class="wrapper">-->
    		...
    		<!--<ul id="navheader" class="reset">-->
    			...
    			<!--<li class="current"><a href="index.htmlhtml">公司</a></li>-->
        ...
        <!--form-->  
            <dl class="c_section c_section_service">
                ...
                <dd>
	                ...
	                <form class="corp_form" action="/Home/Company/bindStep1" method="post" id="bindForm">
						<input type="hidden" name="yanzheng" value="1">
	                    <!--<input type="hidden" value="" id="<?php echo ($company["id"]); ?>">-->
...
<!--<script src="/Public/Home/js/services.min.js" type="text/javascript"></script>-->
			<div class="clear"></div>
...
<script type="text/javascript">
    $("#bindForm").validate({
        ...
        messages: {
            ...
            }, email: {required: "请输入你的公司邮箱", email: "请输入有效的邮箱地址，如：vivi@lagou.com", maxlength: "请输入80字以内的公司邮箱"}
        },
    })
</script>
<!--  -->
