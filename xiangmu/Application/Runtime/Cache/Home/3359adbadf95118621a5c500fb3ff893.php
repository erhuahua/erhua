...
<body id="login_bg">
	<div class="login_wrapper">
		...
		<div class="login_box">
        	<form id="loginForm" method="post" action="/Home/User/register">
    	...
    	// //验证表单
	    	 $("#loginForm").validate({
			    	...
			    	submitHandler:function(form){
			            ...
			            $.ajax({
			            	type:'POST',
			            	data: {username:email,password:password,type:type,resubmitToken:resubmitToken, callback:callback, authType:authType, signature:signature, timestamp:timestamp},
