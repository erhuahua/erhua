...
<div id="body">
    ...
    <div id="container">
        ...
        <div class="content_mid">
            ...
            <dl class="c_section c_section_service">
                ...
                <dd>
                    ...
                    <form class="corp_form" action="bindStep2" method="post" id="companyNameForm">
                        ...
                        <span role="status" aria-live="polite" class="ui-helper-hidden-accessible">测试公司</span>
                        <input type="text" value="" placeholder="请输入与公司营业执照一致的公司全称" name="companyName" id="companyName" class="valid ui-autocomplete-input" autocomplete="off">
                        <!--<input type="hidden" name="yanzheng" value="2">-->
        ...
        <div class="dn" id="loadingDiv" style="display: none;"><img width="32" height="32"
                                                                    src="/Public/Home/images/ajax-loader.gif"></div>
