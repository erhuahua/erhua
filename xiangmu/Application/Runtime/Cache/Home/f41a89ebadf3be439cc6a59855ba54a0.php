...
</script><script type="text/javascript" async="" src="/Public/Home/js/conversion.js"></script><script src="/Public/Home/js/allmobilize.min.js" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>
...
<script src="/Public/Home/js/ajaxCross.json" charset="UTF-8"></script></head>
<body>
<div id="body">
...
<!-- end #header -->
    ...
    <div id="container">
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
 										...
 										<?php if(is_array($)): $i = 0; $__LIST__ = $;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li data-id="1686182" class="onlineResume">
			                                <label class="checkbox">
			                                    <input type="checkbox">
			                                    <i></i>
			                                </label>
			                                <div class="resumeShow">
			                                	<a title="预览在线简历" target="_blank" class="resumeImg" href="resumeView.html?deliverId=1686182">
			                                    	<img src="/Public/Home/images/default_headpic.png">
			                                    </a>
			                                    ...
			                                    <div class="links">
			                                       	<a data-deliverid="1686182" data-name="jason" data-positionid="149594" data-email="888888888@qq.com" class="resume_notice" href="javascript:void(0)" id="tongzhi">通知面试</a>
			                                       	<!-- <a href="javascript:void(0)" id="tongzhi">通知面试</a> -->
...
<!------------------------------------- end -----------------------------------------> <script src="/Public/Home/js/jquery.ui.datetimepicker.min.js" type="text/javascript"></script>
<script src="/Public/Home/js/received_resumes.min.js" type="text/javascript"></script>
<script>
</script>    
			<div class="clear"></div>
