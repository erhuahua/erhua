            	...
            	<div class="profile_box" id="basicInfo">
            		...
            		<div class="basicShow">
            			...
            			<div class="m_portrait">
	                    	<div></div>
	                    	<img width="120" height="120" alt="jason" src="/Public/Home/images/default_headpic.png">
	                    </div>
            		</div><!--end .basicShow-->
...
<div style="display:none;">
	...
	<div class="popup" id="uploadFile">
	    <table width="100%">
	    	...
	    	<tr>
	        	<td align="center"><img width="55" height="16" alt="loading" style="visibility: hidden;" id="loadingImg" src="/Public/Home/images/loading.gif"></td>
	        </tr>
	    </tbody></table>
	</div><!--/#uploadFile-->
