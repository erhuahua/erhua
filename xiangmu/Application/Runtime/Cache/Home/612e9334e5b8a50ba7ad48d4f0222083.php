...
<head>
    ...
    <style type="text/css">.BMap_mask {
        background: transparent url(/Public/Home/images/img/blank.gif);
    }
    ...
    .BMap_zoomer {
        background-image: url(/Public/Home/images/img/mapctrls1d3.gif);
    ...
    .BMap_stdMpPan {
        ...
        height: 44px;
        overflow: hidden;
        background: url(/Public/Home/images/img/mapctrls2d0.png) no-repeat;
    }
    ...
    .BMap_ie6 .BMap_smcbg {
        ...
        width: 44px;
        height: 464px;
        filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="/Public/Home/images/img/mapctrls2d0.png");
    }
    ...
    .BMap_stdMpZoom .BMap_button {
        ...
        left: 12px;
        overflow: hidden;
        background-image: url(/Public/Home/images/img/mapctrls2d0.png);
        background-repeat: no-repeat;
        z-index: 10;
    }
    ...
    .BMap_stdMpType4 .BMap_smcbg {
        position: static;
        background: url(/Public/Home/images/img/mapctrls2d0_mb.png) 0 0 no-repeat;
    ...
    .BMap_stdMpSliderBgTop {
        ...
        width: 10px;
        overflow: hidden;
        background: url(/Public/Home/images/img/mapctrls2d0.png) no-repeat -23px -226px;
    }
    ...
    .BMap_stdMpSliderBgBot {
        ...
        top: 124px;
        overflow: hidden;
        background: url(/Public/Home/images/img/mapctrls2d0.png) no-repeat -33px bottom;
    }
    ...
    .BMap_stdMpSliderBar {
        ...
        top: 80px;
        overflow: hidden;
        background: url(/Public/Home/images/img/mapctrls2d0.png) no-repeat 0 -309px;
    }

    .BMap_stdMpSliderBar.h {
        background: url(/Public/Home/images/img/mapctrls2d0.png) no-repeat 0 -320px;
    }
    ...
    .BMap_omBtn {
        ...
        cursor: pointer;
        overflow: hidden;
        background: url(/Public/Home/images/img/mapctrls1d3.gif) no-repeat;
        z-index: 1210;
    }
    ...
    .BMap_checkbox {
        background: url(/Public/Home/images/img/mapctrls1d3.gif);
    ...
    .BMap_vectex_nodeT {
        background-image: url(/Public/Home/images/img/nodeT.gif);
    }

    .BMap_vectex_node {
        background-image: url(/Public/Home/images/img/node.gif);
    }
    ...
    .iw_search, .iw_l {
        background: url("/Public/Home/images/img/u20LgruGtNFM8lqnNtfK2JqN3CVeW1gzWj9jThd0xd59R8BBgAAiefGO1Bt1gAAAABJRU5ErkJggg==") no-repeat 50% 50%;
        -webkit-background-size: 19px 19px;
    }

    .iw_line_s, .iw_r {
        background: url("/Public/Home/images/img/wCKLRHq20vjSoVNKWunH4rTBDv5Cv7NKeKfvvU2nINzHAuexzUA7KQTkoB6UxDicKvcqfQQYABaiUBxugCsr20AAAAAElFTkSuQmCC") no-repeat 50% 50%;
        -webkit-background-size: 19px 19px;
    }
    ...
    .route_tip_con .route_tip span {
        ...
        width: 14px;
        height: 13px;
        background: url(/Public/Home/images/img/addrPage.png) no-repeat 0 -121px;
        cursor: pointer;
    }
    ...
    .sel_n .sel_top {
        background: url(/Public/Home/images/img/bgs.gif) no-repeat 0 -418px;
        height: 4px;
        font-size: 0px;
    }
    ...
    .sel_n .sel_body_top {
        height: 32px;
        width: 100%;
        background: url(/Public/Home/images/img/addrPage.png) no-repeat 0 -41px;
    }
    ...
    .sel_n .sel_body_sign {
        ...
        height: 31px;
        float: left;
        background: url(/Public/Home/images/img/bgs.gif) no-repeat -79px -387px;
    }
    ...
    .sel_n .sel_bottom {
        background: url(/Public/Home/images/img/bgs.gif) no-repeat 0 -415px;
        height: 4px;
        font-size: 0px;
    }
    ...
    .sel_n1 .sel_body_top {
        height: 31px;
        width: 100%;
        background: url(/Public/Home/images/img/sel_body_n_top.gif) repeat-x;
    }
    ...
    .sel_n1 .sel_body_button {
        ...
        height: 31px;
        margin-left: -23px;
        background: url(/Public/Home/images/img/bgs.gif) no-repeat -253px -382px;
        overflow: hidden;
        zoom: 1;
        cursor: pointer;
    }
    ...
    .sel_y .sel_top {
        background: url(/Public/Home/images/img/bgs.gif) no-repeat 0 -439px;
        height: 4px;
        zoom: 1;
        font-size: 0px;
    }
    ...
    .sel_y .sel_body_top {
        height: 32px;
        width: 100%;
        background: url(/Public/Home/images/img/addrPage.png) no-repeat 0 0
    }
    ...
    .sel_y .sel_body_sign {
        ...
        height: 31px;
        float: left;
        background: url(/Public/Home/images/img/bgs.gif) no-repeat -167px -384px;
    }
    ...
    .sel_y .sel_body_button {
        ...
        height: 31px;
        margin-left: -20px;
        background: url(/Public/Home/images/img/bgs.gif) no-repeat -269px -297px;
        cursor: pointer;
    }
    ...
    .sel_y .sel_bottom {
        background: url(/Public/Home/images/img/bgs.gif) no-repeat 0 -436px;
        height: 4px;
        font-size: 0px;
    }
    ...
    .sel_x .sel_body_sign {
        ...
        height: 31px;
        float: left;
        background: url(/Public/Home/images/img/bgs.gif) no-repeat -122px -384px;
    }
    ...
    .sel_body_resitem th div.iconbg {
        background: url(/Public/Home/images/img/markers_new_ie6.png) no-repeat scroll 0 0;
        height: 29px;
        width: 24px;
    }
    ...
    .sel_body_resitem td .selBtn {
        width: 70px;
        height: 29px;
        background: url(/Public/Home/images/img/addrPage.png) no-repeat -21px -81px;
        text-align: center;
        line-height: 29px;
        visibility: hidden;
        color: #b35900;
    ...
    <link rel="stylesheet" href="/Public/Home/css/window.css">
</head>
<body>
<div id="body">
    <!--<div id="header">-->
        <!--<div class="wrapper">-->
            <!--<a class="logo" href="index.html">-->
                <!--<img width="229" height="43" alt="拉勾招聘-专注互联网招聘" src="/Public/Home/images/logo.png">-->
            <!--</a>-->
            <!--<ul id="navheader" class="reset">-->
                <!--<li><a href="index.html">首页</a></li>-->
                <!--<li><a hrindex.htmlhtml">公司</a></li>-->
    ...
    <div id="container">
        ...
        <div class="sidebar">
            <a class="btn_create" href="create.html">发布新职位</a>
                ...
                <dt>我收到的简历</dt>
                <dd>
                    <a href="waitResumes.html">待处理简历</a>
                </dd>
                <dd>
                    <a href="canInterviewResumes.html">待定简历</a>
                </dd>
                <dd>
                    <a href="noticeResumes.html">已通知面试简历</a>
                </dd>
                <dd>
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <dd>
                    ...
                    <form action="/Home/Company/create" method="post" id="jobForm">
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td width="85">工作性质</td>
                                <td>
                                    <ul class="profile_radio clearfix reset" id="xingzhi">
                                        <li>
                                            全职<em></em>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" placeholder="请输入工作城市，如：北京" value="上海" name="workAddress"
                                           id="workAddress">
                                 <!--    <input type="text" placeholder="清输入工作城市" name="workAdd"> -->
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td>工作地址</td>
                                <td>
                                <input type="text" class="input_520" placeholder="请输入工作地址" id="address">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <input type="button" value="发布" id="qwer" class="btn_32">
                                </td>
                            </tr>
                            </tbody>
                        </table>
        ...
        <div style="display:none;">
            ...
            <div class="popup" id="baiduMap">
                ...
                <div id="allmap"
                    ...
                    <div style="position: absolute; z-index: 1201; top: 10px; right: 10px; width: 17px; height: 16px; background: url(/Public/Home/images/img/st-close.pngquot) no-repeat scroll 0% 0% transparent; cursor: pointer; display: none;"
                         title="退出全景"></div>
                    <div style="height: 32px; position: absolute; z-index: 30; -moz-user-select: none; bottom: 0px; right: auto; top: auto; left: 1px; display: none;"
                         class=" anchorBL"><a title="到百度地图查看此区域" target="_blank" href="http://map.baidu.com/?sr=1"
                            ...
                            src="/Public/Home/images/copyright_logo.png" style="border:none;width:77px;height:32px"></a>
                    </div>
                    ...
                    <div unselectable="on" class=" BMap_scaleCtrl BMap_noprint anchorBL"
                        ...
                        <div class="BMap_scaleBar BMap_scaleHBar" style="background-color: black;"><img
                                src="/Public/Home/images/mapctrls.png" style="border:none"></div>
        ...
        <!------------------------------------- end ----------------------------------------->
        <!-- <script type="text/javascript" src="/Public/Home/js/tinymce.min.js"></script>
<script>
$(function(){
	...
	tinymce.init({
        ...
        <!-- old -->
        <script src="/Public/Home/js/jquery.tinymce.js" type="text/javascript"></script>
        <script>
        ...
        <script src="/Public/Home/js/jobs.min.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
            $(function(){
                $('#jobForm').click(function(){
                    // alert('aaa');
                    // return;
                    var name = $('#select_category').val() + '/' + $('#positionName').val();;//职位类别
                    var branch = $('#department').val();//所属部门
                    // var nature = $('#xingzhi').val();
                    var nature = $('input:radio[name="jobNature"]:checked').val();//工作性质
                    var salary_high = $('#salary_high').val();//薪资范围
                    var salary_low = $('#salary_low').val();//薪资范围
                    var city = $('#workAddress').val();//工作城市
                    var work_year = $('#select_experience').val();//工作经验
                    var edu = $('#select_education').val();//学历
                    var welfare = $('#positionAdvantage').val();//职位诱惑
                    var desc = $('#miaoshu').val();//职位描述
                    var address = $('#address').val();//工作地址
                    var email = $('#forwardEmails').val();//工作地址
                    ...
                    // if (!$("#forwardEmail").val().match(reg)){
                    //     alert('邮箱格式不正确');
                    //     return;
                    // }
                                
                    var data = {name:name,branch:branch,nature:nature,salary_high:salary_high,salary_low:salary_low,city:city,work_year:work_year,edu:edu,welfare:welfare,desc:desc,address:address,email:$("#forwardEmail").val()};
                    // console.log(data);return;
                       $.ajax({
                            type:'POST',
                            data: data,
                            url:"/Home/Company/create",
                            dataType:'json',
                            success:function(response){
                                ...
                                //     alert(response.msg);
                                // }else{
                                //     location.href='/Home/Company/index';
                                // }
                            }                   
                        });
                })
