...
class Page{
    ...
    private $config  = array(
        'Common' => '<span class="rows">共 %TOTAL_ROW% 条记录</span>',
        'prev'   => '<<',
        'next'   => '>>',
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
    ...
    public function show() {
        ...
        $page_str = str_replace(
            ...
            array($this->config['Common'], $this->nowPage, $up_page, $down_page, $the_first, $link_page, $the_end, $this->totalRows, $this->totalPages),
            $this->config['theme']);
