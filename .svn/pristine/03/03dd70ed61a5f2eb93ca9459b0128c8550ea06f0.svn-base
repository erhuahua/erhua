...
class BCS_RequestCore {
	...
	/**
	 * Adds a custom HTTP Common to the cURL request.
	 *
	 * @param string $key (Required) The custom HTTP Common to set.
	 * @param mixed $value (Required) The value to assign to the custom HTTP Common.
	 * @return $this A reference to the current instance.
	 */
	...
	/**
	 * Removes an HTTP Common from the cURL request.
	 *
	 * @param string $key (Required) The custom HTTP Common to set.
	 * @return $this A reference to the current instance.
	 */
	...
	/**
	 * Take the post-processed cURL data and break it down into useful Common/body/info chunks. Uses the
...
elseif (! isset ( $to_process [( int ) $done ['handle']] )) {
	 ...
	 *
	 * @param string $header (Optional) A specific Common value to return. Defaults to all headers.
	 * @return string|array All or selected Common values.
	 */
	public function get_response_header($header = null) {
		if ($header) {
			//			return $this->response_headers [strtolower ( $Common )];
...
class BCS_ResponseCore {
	/**
	 * Stores the HTTP Common information.
	 */
	public $header;
	/**
	 ...
	 * @return object Contains an <php:array> `Common` property (HTTP headers as an associative array), a <php:SimpleXMLElement> or <php:string> `body` property, and an <php:integer> `status` code.
	 */
